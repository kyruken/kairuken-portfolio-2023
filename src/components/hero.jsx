...
export default function Hero() {
    return (
        <header className='flex-column ai-center jc-center padding-tb-4' id='home'>
            ...
            <a href="https://www.linkedin.com/in/kyle-arenas-49224a22a/"><img className='side-button side-button-l' src="../src/assets/linkedin.png" width="50"></img></a>
            <a href="https://github.com/kyruken"><img className='side-button side-button-g' src="../src/assets/github.png" width="50"></img></a>
            <a href=""><img className='side-button side-button-e' src="../src/assets/email.png" width="50"></img></a>
        </header>
    )
}