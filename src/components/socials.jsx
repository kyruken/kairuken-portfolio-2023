        ...
        <section className='socials padding-lr-3 padding-tb-5'>
            ...
            <div className='flex-column gap-3 socials-container'>
                ...
                <div className="flex ai-center gap-0">
                    ...
                    <div className='flex-1 text-elli'>
                        <span>Linkedin: </span>
                        <a target="_blank" href='https://www.linkedin.com/in/kyle-arenas-49224a22a/'>https://www.linkedin.com/in/kyle-arenas-49224a22a/</a>
                    </div>
                </div>
                ...
                <div className="flex ai-center gap-0">
                    ...
                    <span>Github: </span>
                    <a target="_blank" href='https://github.com/kyruken'>https://github.com/kyruken</a>
                </div>
            </div>
        </section>
    )
